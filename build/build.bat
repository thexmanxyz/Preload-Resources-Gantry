...
REM #######################################################
REM #                                                     #
REM #   Preload Resources - Atom for Gantry               #
REM #                                                     #
REM #   Purpose: This project provides the functionality  #
REM #            to manually define which static          #
REM #            resources should be preloaded.           #
REM #                                                     #
REM #   Author: Andreas Kar (thex) <andreas.kar@gmx.at>   #
REM #   Repository: https://git.io/fjVkM                  #
